...
public class StreamDemo {
    ...
    public static void main(String[] args) {
        ...
        // 获取空字符串的数量
        long count0 = strings2.stream().filter(string -> string.isEmpty()).count();
        /*limit
        ...
        // 获取空字符串的数量
        long count = strings3.parallelStream().filter(string -> string.isEmpty()).count();
